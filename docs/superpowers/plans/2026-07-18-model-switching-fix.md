...
```bash
ssh fihadmin@herald-host.internal "cd /home/fihadmin/hermes-ios-work && git pull origin master"
ssh fihadmin@herald-host.internal "cp /home/fihadmin/hermes-ios-work/relay/app/main.py /home/fihadmin/Hermes-iOS/relay/app/main.py && cp /home/fihadmin/hermes-ios-work/relay/app/schemas.py /home/fihadmin/Hermes-iOS/relay/app/schemas.py"
ssh fihadmin@herald-host.internal "cd /home/fihadmin/deploy/hermes-relay && docker compose down && docker compose up -d --build"
```
...
```bash
ssh fihadmin@herald-host.internal "cp -r /home/fihadmin/hermes-ios-work/connector/src /home/fihadmin/Hermes-iOS/connector/"
...
```bash
ssh fihadmin@herald-host.internal "CREDS=\$(cat /home/fihadmin/.hermes/profiles/ignyte/home/.hermes-mobile/state.json | python3 -c 'import json,sys; print(json.load(sys.stdin)[\"connector_credential\"])') && curl -s http://localhost:8010/v1/models -H \"Authorization: Bearer \$CREDS\""
```
