...
```bash
ssh fihadmin@herald-host.internal
...
```bash
# Still on fihadmin@herald-host.internal
cd ~/Hermes-iOS
...
|-----------|----------|------|
| Relay (Docker) | `fihadmin@herald-host.internal`, deploy dir `/home/fihadmin/deploy/hermes-relay` | 8010 |
